...
ggplot(plot1data_counted) + 
  ...
  labs(title = "College GPA vs High School Training Days per Week", x = "High School Training Days per Week", y = "College GPA")+
...
ggplot(plot1data2_counted) + 
  ...
  labs(title = "College GPA vs. College Training Days per Week", x = "College Training Days per Week", y = "College GPA") +
  scale_color_brewer(palette = "Reds") +
  theme_minimal()
```
...
ggplot(plot1data3_counted) + 
  ...
  labs(title = "High School GPA vs High School Training Days per Week", x = "High School Training Days per Week", y = "High School GPA") +
  scale_color_brewer(palette = "Reds") +
  theme_minimal()
```
